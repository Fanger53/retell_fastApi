...
twilio_client.register_phone_agent(os.getenv("PHONE_NUMBER"), os.getenv('INBOUND_RETELL_AGENT_ID'))
...
async def handle_twilio_voice_webhook(request: Request):
    ...
    call = twilio_client.create_phone_call(os.getenv("PHONE_NUMBER"), to_number, os.environ['OUTBOUND_RETELL_AGENT_ID'], custom_variables)#from,to
